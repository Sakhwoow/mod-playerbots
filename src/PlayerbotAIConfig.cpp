...
bool PlayerbotAIConfig::Initialize()
{
    ...
    maxMovementSearchTime = sConfigMgr->GetOption<int32>("AiPlayerbot.MaxMovementSearchTime", 1);
    ...
    randomBotTurboInit = sConfigMgr->GetOption<bool>("AiPlayerbot.RandomBotTurboInit", false);
    ...
    // maxBotsInRealGuild = sConfigMgr->GetOption<uint32>("AiPlayerbot.MaxBotsInRealGuild", 50);  // mod-guild-bots
    // guildBotMinOnline = sConfigMgr->GetOption<uint32>("AiPlayerbot.GuildBotMinOnline", 0);      // mod-guild-bots
    ...
    botTitleId = sConfigMgr->GetOption<uint32>("AiPlayerbot.BotTitleId", 172);
